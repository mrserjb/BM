            ...
            <div className={'footer'}>
                ...
                >
                    ...
                    <p className={'footer_p'}
                        ...
                        {tp.execute('Краснодарский край')} <br />
                        {tp.execute('Сочи, ул. Конституции СССР, дом 18, пом. 618')} <br />
                        {tp.execute('Телефон: +7 (963) 347-3675, +7 (962) 883-9222')}<br />
                        {tp.execute('E-mail: ek@бизнесмаркет.com, ks@бизнесмаркет.com')}<br /><br />
